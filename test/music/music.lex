...
##%merge=声音类型;
歌曲名other=.+;
当前歌曲=(这个|这首|这)(歌|曲子|音乐|歌曲)=>("current");
...
######场景
场景_睡觉=睡了|睡觉|睡前|睡觉前|困了 =>("睡觉");
#场景_睡觉=睡了|睡觉|睡前|催眠|午休|睡眠|休息 =>("睡眠");
场景_健身=运动|健身 =>("健身");
场景_阅读=看书|阅读|学习|读书 =>("阅读");
场景_工作=工作|干活|上班=>("工作");
场景_毕业=毕业|毕业典礼=>("毕业");
场景_上网=(上网|上网的|上网听的|适合上网听的|上网的时候听的) =>("上网");
场景_雨天=(雨天|雨天的|下雨天的|适合雨天听的|适合下雨天听的|下雨的时候听的) =>("雨天");
场景_起床=(起床|起床的|起床听的|适合起床听的|起床的时候听的) =>("起床");
场景_洗澡=(洗澡|洗澡的|洗澡听的|适合洗澡听的|洗澡的时候听的) =>("洗澡");
场景_散步=(散步|散步的|散步听的|适合散步听的|散步的时候听的) =>("散步");
场景_KTV=(KTV必点|KTV必点的|KTV必点|KTV必点的|KTV) =>("KTV");
场景_蹦迪=(蹦迪|蹦迪的|蹦迪听的|适合蹦迪听的|蹦迪的时候听的) => ("蹦迪");
场景_早晨=(清晨|清晨听的|早晨听的|早上听的|适合清晨听的|适合早晨听的|适合早上听的) => ("早晨");
场景=胎教|幼儿园|起床|刷牙|吃饭|游戏|健身|读书|看书|工作|瑜伽|运动|阅读|学习|干活|午休|睡眠|休息|广场舞|跳舞|催眠|${场景_睡觉}|酒吧|夜店|咖啡馆|沙发|喝咖啡|聚会|约会|做家务|做饭|打扫卫生|跑步|散步|运动|健身|锻炼|KTV|上班|${场景_毕业}|清晨|旅行|开车|${场景_上网}|${场景_雨天}|${场景_起床}|${场景_洗澡}|${场景_KTV}|${场景_蹦迪}|${场景_早晨};
...
######音乐类型
音乐类型1=(串烧|乡村|原声带|原声带摇滚|另类|合唱|嘻哈|婚礼|弹唱|朋克|清唱|爵士|经典|翻唱|蓝调|说唱|中国风|古典|草原|现代|流行|电音|电子|亲子|新世纪|古风)(歌曲|歌|音乐|乐|曲)? => ("$1");
音乐类型2=(HIPHOP|MTV|RANDB|RAP|RB|R&B|RPA|SOLO|R AND B流行|陕西民歌|音乐剧|诗歌|老歌|舞曲|美声|红歌|秦腔|苏格兰小调|男双对唱|男女合唱|男女对唱|男男合唱|男男对唱|祝酒歌|求爱歌|斗牛士舞曲|校园民谣|摇篮曲|摇篮歌|快歌|慢歌|情歌|客家山歌|山歌|山西民歌|大合唱|奏鸣曲|女女合唱|女女对唱|东北民歌|K歌经典|K歌经曲|K歌金曲|交响乐|三重奏|伴奏|圣经|水声|混音|热恋慢歌|独奏|布鲁斯|舞台|黄梅戏|昆曲|歌剧|豫剧|越剧|粤剧|戏曲|京剧|电子|恐怖灵异|民谣|二次元|JAZZ|POP|经典老歌|${lx_乡村}|情歌对唱|${lx_朋克}|ACG|雷鬼|${lx_beatbox}|${lx_SOUL}|${lx_dj}|${lx_交响乐}|${lx_草原}|${lx_说唱}|${lx_圆舞曲}|${lx_朋克}|${lx_黑人}|${lx_基督}|${lx_和声}) => ("$1");
...
电子舞曲=EDM|电子舞曲 => ("电子舞曲");
音乐类型3=${佛教歌曲}|${儿童歌曲}|${军旅歌曲}|${民族歌曲}|${爱情歌曲}|${网络歌曲}|${胎教歌曲}|${轻声歌曲}|${金属歌曲}|${摇滚歌曲}|${摇篮歌曲}|${慢摇歌曲}|${藏族歌曲}|${影视歌曲}|${幼儿歌曲}|${催眠歌曲}|${纯音乐}|${HIGH歌}|${神曲}|文艺|${电子舞曲};
zy快 = (快|快速) => ("快歌");
zy慢 = (慢|慢速) => ("慢歌");
音乐类型_快慢歌 = (${zy快}|${zy慢})(节奏)(的)?(歌|歌曲|音乐|曲子) => ("$1");
音乐类型=${音乐类型1}|${音乐类型2}|${音乐类型3}|${音乐类型_快慢歌}|胎教DJ|DJ儿歌|后摇;
##########语种
...
意大利语=(意大利|意大利语) => ("意大利语");
印度语=印度语|印度 => ("印度语");
语种=${英文}|${日文}|${泰文}|${法文}|${粤语}|${华语}|${韩文}|丹麦语|俄语|克罗地亚语|匈牙利|台湾|台语|土耳其语|巴西葡萄牙语|希腊语|${意大利语}|挪威语|捷克语|斯洛伐克语|斯洛文尼亚语|日韩|欧美|波兰语|济南话|瑞典语|美国|芬兰语|荷兰语|藏族|${西班牙语}|越南|重庆|${闽南语}|阿拉伯语|香港|港台|内地|${拉丁}|${德文}|${俄语}|${藏语}|小语种|${印度语};
...
主题=(${.music_主题_del的}|${.music_影视名称}|${.music_主题})(第${m中文整数}季)?(第${m中文整数}期)?(第${m中文整数}集)?(第${m中文整数}场)?(第${m中文整数}节)?|韩剧|纯人声|${ms_哔哩哔哩}|英剧|${zt_美剧}|${zt_试音}|${zt_影视歌曲}|${zt_格莱美}|${zt_歌舞剧音乐}|广告|中国新歌声|中国有嘻哈|明日之子|跨界歌王|中国情歌汇|金曲捞|歌手|我是歌手|中国好歌曲|中国好声音|天籁之战|梦想的声音|蒙面歌王|蒙面唱将猜猜猜|围炉音乐会;
...
风格=${.music_风格}|世界|亲热|生日|网络|动漫|校园|温暖|郁闷|疲惫|青春|休闲|小清新|清新|伤心|失恋|${武侠}|${fg_舒缓}|${fg_寂寞}|${fg_节奏感}|${fg_抒情}|${fg_冷门}|${fg_治愈}|温馨|活泼|疗伤|${fg_性感}|调情;
##排行榜=${.music_排行榜};
######排行榜
...
排行_最热=(最近|最近比较|比较|最)?(最热|最热门|最近流行|热门|最火|最近比较火|最近比较热门|最近比较热|排行榜最热|最热排行榜|排行榜最火|最热的排行榜|最火的排行榜|大家听得多|比较热|比较火|比较流行|听的最多|大家听的最多|最流行|热歌) =>("最热");
####add by xuyang
...
music_听=听些|我想听|听听|听一下|听一个|听一些|听些|听个|听一点|听(一|几|两|${整数})?首 => ("收听");
...
单曲循环=一直放这首|就放这首|只放这首|只听这个|单曲循环|单个循环|只放这个|只听这首|只播这个|只播这首 => ("单曲循环");
