...
export poetry1=(我想听|我要听){量词}?({poe古诗_类别}) => request(对象="3", 操作="收听") <0.2>;
export poetry1=(我想看|我要看){量词}?({poe古诗_类别}) => request(对象="3", 操作="观看") <0.2>;
...
##### 支持新说法 #####
## 朗读(操作归一到"说") ##
export poetry7_1=({poe说}){量词}?({poe古诗_类别}) 
export poetry8_1 = (播|放|播放){量词}?({poe古诗_类别}) 
...
export gushi4=({古诗_诗句})(是|来自|出自)?(谁){停用词}?,(大作|写的|作品|所作|所写|所创作|创作|提出|发表|写出|诗|词|古诗) 

#给句子问古诗名
export gushi4=({古诗_诗句})(是|来自|出自)?(哪|那)(首|个)(诗|词|古诗|唐诗)(里的|里面的|的)?(句子)? 
